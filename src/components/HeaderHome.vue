    ...
    <template v-slot:start>
      <div class="flex w-7/12 gap-3">
        ...
        <div class="text-gray-300">
          ...
          <small class="font-medium text-sm">Hey there, let's go green!</small>
        </div>
      </div>
    </template>
    <template v-slot:end>
      <div class="text-lg text-gray-300">
        <span
          class="mr-5 relative active:scale-95 duration-300"
        ...
        <!--
        <i
          @click="showFloatingBtn = !showFloatingBtn"
          class="relative fa fa-ellipsis-h"
        >
          <div
